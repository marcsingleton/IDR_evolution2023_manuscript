...
\begin{figure}[h!]
\includegraphics[width=6in]{scores/out/scores_histogram.png}
\centering
...
\begin{figure}[h!]
\includegraphics[width=\textwidth]{hierarchy/out/hierarchy_mu_OU.png}
\centering
\caption{\textbf{Hierarchical clustering of normalized optimal values.}
The optimal values of the OU model ($\mu_{OU}$) are clustered with the same method as the signatures derived from the log likelihood ratios in Fig~\ref{fig:hierarchy}. The optimal values are expressed as $z$-scores relative to each feature distribution in the subset of rapidly evolving disorder regions. Values below or above negative or positive three are indicated with magenta and cyan, respectively.}
\label{sfig:hierarchy_mu}
\end{figure}

...
gs = plt.GridSpec(2, 3)
gridspec_kw = {'left': 0.25, 'right': 0.95, 'bottom': 0.2, 'top': 0.9}
...
# --- PANEL D: Type I error as function of critical value ---
...
# --- PANEL E: Type I error as function of critical value (merge) ---
errors = []
for critval in critvals:
